  ...
  return await database.using(async function (pool) {
    ...
    if (parameters.iId > 0) {
      ...
      await pool
        ...
        .input("iCredits", sql.Decimal(10,2), parameters.iCredits || 10000.00)
        .input("iCreditsUsed", sql.Decimal(10,2), parameters.iCreditsUsed || 0.00)
        .input("iMultiplier", sql.Int, parameters.iMultiplier || 1000)
        .input("iTokens", sql.BigInt, parameters.iTokens || 10000000)
